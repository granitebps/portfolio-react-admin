...
import { Eye, Code, XCircle, Trash, Trash2, Delete, MinusCircle } from 'react-feather';
    ...
    return (
      <React.Fragment>
        <Card>
          ...
          <CardBody>
            <p>
              You can use prop <code>closableIcon</code> with prop <code>closable</code> to create a
              chip with customized close icon.
            </p>
