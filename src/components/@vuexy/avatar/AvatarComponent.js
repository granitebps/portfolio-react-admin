    ...
    return (
      <div
        className={classnames(
          `avatar ${this.props.color ? `bg-${this.props.color}` : null}  ${this.props.className}`,
          {
        ...
        {this.props.img === false || this.props.img === undefined ? (
          <span
            ...
            {this.props.icon ? <div className="avatar-icon">{this.props.icon}</div> : null}
            {this.props.badgeUp ? (
              <Badge
                color={this.props.badgeColor ? this.props.badgeColor : 'primary'}
        ...
        {this.props.status ? <span className={`avatar-status-${this.props.status}`}></span> : null}
      </div>
    );
  }
}
